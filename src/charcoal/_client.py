...
from ._exceptions import CharcoalError, APIStatusError
...
if TYPE_CHECKING:
    from .resources import api_keys, namespaces
    from .resources.api_keys import APIKeysResource, AsyncAPIKeysResource
    from .resources.namespaces.namespaces import NamespacesResource, AsyncNamespacesResource
...
class Charcoal(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Charcoal client instance.

        This automatically infers the `api_key` argument from the `CHARCOAL_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("CHARCOAL_API_KEY")
        if api_key is None:
            raise CharcoalError(
                "The api_key client option must be set either by passing api_key to the client or by setting the CHARCOAL_API_KEY environment variable"
            )
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("CHARCOAL_BASE_URL")
        if base_url is None:
            base_url = f"https://api.withcharcoal.com"

        custom_headers_env = os.environ.get("CHARCOAL_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> CharcoalWithRawResponse:
        return CharcoalWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> CharcoalWithStreamedResponse:
        return CharcoalWithStreamedResponse(self)
...
class AsyncCharcoal(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncCharcoal client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncCharcoalWithRawResponse:
        return AsyncCharcoalWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncCharcoalWithStreamedResponse:
        return AsyncCharcoalWithStreamedResponse(self)
...
class CharcoalWithRawResponse:
    _client: Charcoal

    def __init__(self, client: Charcoal) -> None:
        self._client = client
...
class AsyncCharcoalWithRawResponse:
    _client: AsyncCharcoal

    def __init__(self, client: AsyncCharcoal) -> None:
        self._client = client
...
class CharcoalWithStreamedResponse:
    _client: Charcoal
...
class AsyncCharcoalWithStreamedResponse:
    _client: AsyncCharcoal
